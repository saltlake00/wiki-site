...
REM ---- adjust BASE below if sprite-gen is installed elsewhere ----
set "BASE=G:\내 드라이브\wiki\projects\gamedev\pixel-sprite-workflow"
set "PY=%BASE%\sprite-gen\.venv\Scripts\python.exe"

if not exist "%PY%" (
  echo [ERROR] python.exe not found:
  echo   %PY%
  echo   Edit BASE at the top of this file to point to your sprite-gen install.
  pause
  exit /b 1
)
...
REM ---- choose run-dir ----
set "RUN_DIR=%~1"
if "%RUN_DIR%"=="" set "RUN_DIR=%BASE%\test-assets\varco-fantasy\run"
